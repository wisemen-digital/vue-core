...
import { VcCheckboxGroup, VcCheckboxIndicator, VcCheckbox } from '@wisemen/vue-core'
import { ref } from 'vue'
...
const items = [
  {
    label: 'Apple',
    value: 'Apple',
    description: 'Mmm, delicious apples.',
  },
  {
    label: 'Banana',
    value: 'Banana',
  ...
  },
  {
    ...
    value: 'Blueberry',
    isDisabled: true,
    description: 'Blueberries are a good source of antioxidants.',
  },
]
</script>
...
<template>
  ...
  >
   <div class="grid grid-cols-3 gap-4">
      ...
      >
        <VcCheckboxIndicator class="absolute top-1 right-1 scale-75" />
