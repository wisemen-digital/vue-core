...
<PropsTable :data="[
  ...
  },
  {
    ...
    'type': 'SelectDisplayFn<AcceptableValue>',
    'required': true
  },
  {
    'name': 'errorMessage',
  ...
  },
  {
    ...
    'type': '{ isEnabled: boolean; isInline?: boolean; fn?: SelectFilterFn<AcceptableValue>; } | null',
    'required': false
  },
  {
    'name': 'hint',
  ...
  {
    'name': 'items',
    'description': '<p>The items to display.</p>\n',
