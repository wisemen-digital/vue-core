...
import {
  ...
  AppTablePageCount,
  AppTablePagination,
  AppTablePaginationFirstPage,
  AppTablePaginationLastPage,
  AppTablePaginationNextPage,
  AppTablePaginationPages,
  AppTablePaginationPrevPage,
  usePagination,
  ...
  >
    ...
    <template #bottom>
      <div class="flex w-full items-center justify-between">
        <AppTablePagination v-slot="{ items }">
