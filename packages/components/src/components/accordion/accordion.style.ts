...
export const useAccordionStyle = tv({
  slots: {
    ...
    content: 'overflow-hidden bg-white text-black data-[state=closed]:animate-slideUp data-[state=open]:animate-slideDown',
    ...
    trigger: 'group flex flex-1 cursor-pointer items-center justify-between gap-10 border-t border-solid border-primary/10 bg-white px-3 py-2 text-black outline-none hover:bg-muted-background',
  },
})
