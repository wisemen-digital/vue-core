...
export const textFieldStyle = tv({
  slots: {
    ...
    iconleft: 'box-content shrink-0 pl-text-field-icon-left-padding-left-default duration-200 [--icon-color:var(--text-field-icon-color-default)] [--icon-size-default:var(--text-field-icon-size-default)]',
    iconright: 'box-content shrink-0 pr-text-field-icon-right-padding-right-default duration-200 [--icon-color:var(--text-field-icon-color-default)] [--icon-size-default:var(--text-field-icon-size-default)]',
