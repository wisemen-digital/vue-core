...
export const radioGroupStyle = tv({
  ...
  slots: {
    ...
    inputLabel: '[--input-field-label-font-size-default:var(--radio-group-label-font-size-default)] [--input-field-label-font-weight-default:var(--radio-group-label-font-weight-default)] [--input-field-label-text-color-default:var(--radio-group-label-text-color-default)]',
