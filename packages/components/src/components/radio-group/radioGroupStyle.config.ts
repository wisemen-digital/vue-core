...
export interface RadioGroupStyleConfig extends BaseStyleConfig {
  ...
  // Error
  '--radio-group-item-error-font-size-default': string
  '--radio-group-item-error-font-weight-default': string
  '--radio-group-item-error-spacing-default': string

  '--radio-group-item-error-text-color-default': string
  // Hint
...
defineStyleConfig({
  config: {
    ...
    '--radio-group-item-error-font-size-default': 'var(--input-field-error-font-size-default)',
    '--radio-group-item-error-font-weight-default': 'var(--input-field-error-font-weight-default)',
    '--radio-group-item-error-spacing-default': '0px',

    '--radio-group-item-error-text-color-default': 'var(--input-field-error-text-color-default)',
    ...
    '--radio-group-item-indicator-size-hover': '4px',
