...
<template>
  <SwitchRoot
    ...
    class="w-10 rounded-2xl bg-switch-background p-0.5 outline-none ring-offset-2 ring-offset-background duration-300 focus-visible:ring-2 disabled:cursor-not-allowed disabled:opacity-50"
  >
