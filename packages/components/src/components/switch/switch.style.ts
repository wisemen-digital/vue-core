...
export const switchStyle = tv({
  ...
  slots: {
    ...
    indicator: 'size-switch-indicator-size-default flex-none rounded-switch-indicator-border-radius-default border-switch-indicator-border-width-default border-solid border-switch-indicator-border-color-default bg-switch-indicator-bg-color-default duration-300 ease-switch data-[state=checked]:translate-x-[calc(var(--switch-width-default)-(var(--switch-padding-x-default)*2)-var(--switch-indicator-size-default)-var(--switch-indicator-border-width-default))] ',
  ...
  variants: {
    isFocused: {
      true: {
        ...
        indicator: 'border-switch-indicator-border-color-focus bg-switch-indicator-bg-color-focus',
    ...
    isHovered: {
      true: {
        ...
        indicator: 'border-switch-indicator-border-color-hover bg-switch-indicator-bg-color-hover',
    ...
    isChecked: {
      true: {
        ...
        indicator: 'border-switch-indicator-border-color-checked bg-switch-indicator-bg-color-checked',
    ...
    hasError: {
      true: {
        ...
        indicator: 'border-switch-indicator-border-color-error bg-switch-indicator-bg-color-error',
    ...
    isDisabled: {
      true: {
        ...
        indicator: 'border-switch-indicator-border-color-disabled bg-switch-indicator-bg-color-disabled',
