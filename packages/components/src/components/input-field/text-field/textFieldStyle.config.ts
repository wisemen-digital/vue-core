...
defineStyleConfig({
  config: {
    ...
    '--text-field-error-font-size-default': 'var(--text-subtext)',
    '--text-field-error-font-weight-default': '400',
    '--text-field-error-spacing-default': 'var(--spacing-sm)',
    '--text-field-error-text-color-default': 'var(--text-error-primary)',
    '--text-field-font-size-default': '14px',
    '--text-field-font-weight-default': '400',
    '--text-field-height-default': '40px',
    '--text-field-hint-font-size-default': 'var(--text-subtext)',
    '--text-field-hint-font-weight-default': 'var(--input-field-hint-font-weight-default)',
    '--text-field-hint-spacing-default': 'var(--spacing-sm)',
    '--text-field-hint-text-color-default': 'var(--text-tertiary)',
    '--text-field-hint-text-color-disabled': 'var(--text-tertiary)',
    '--text-field-hint-text-color-error': 'var(--text-tertiary)',
    '--text-field-hint-text-color-focus': 'var(--text-tertiary)',
    '--text-field-hint-text-color-hover': 'var(--text-tertiary)',
    ...
    '--text-field-label-font-size-default': 'var(--text-subtext)',
    '--text-field-label-font-weight-default': '500',
    '--text-field-label-spacing-default': 'var(--spacing-sm)',
    '--text-field-label-text-color-default': 'var(--text-secondary)',
    '--text-field-label-text-color-disabled': 'var(--text-secondary)',
    '--text-field-label-text-color-error': 'var(--text-secondary)',
    '--text-field-label-text-color-focus': 'var(--text-secondary)',
    '--text-field-label-text-color-hover': 'var(--text-secondary)',
