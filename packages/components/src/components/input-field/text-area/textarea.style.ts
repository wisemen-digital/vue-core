  ...
  variants: {
    ...
    isFocused: {
      true: {
        ...
        textarea: 'border-b-textarea-border-bottom-color-focus border-l-textarea-border-left-color-focus border-r-textarea-border-right-color-focus border-t-textarea-border-top-color-focus bg-textarea-bg-color-focus text-textarea-text-color-focus shadow-textarea-shadow-focus ring-2 ring-textarea-ring-color-focus placeholder:text-textarea-placeholder-color-focus',
      },
    },
    hasError: {
      true: {
        ...
        textarea: 'border-b-textarea-border-bottom-color-error border-l-textarea-border-left-color-error border-r-textarea-border-right-color-error border-t-textarea-border-top-color-error bg-textarea-bg-color-error text-textarea-text-color-error shadow-textarea-shadow-error ring-textarea-ring-color-error placeholder:text-textarea-placeholder-color-error',
      },
    },
    resizeMode: {
      'auto-vertical': {
