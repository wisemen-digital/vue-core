  ...
  variants: {
    isDisabled: {
      true: {
        ...
        input: 'cursor-not-allowed text-select-text-color-disabled placeholder:text-select-placeholder-color-disabled',
        ...
        trigger: 'cursor-not-allowed border-b-select-border-bottom-color-disabled border-l-select-border-left-color-disabled border-r-select-border-right-color-disabled border-t-select-border-top-color-disabled bg-select-bg-color-disabled shadow-select-shadow-disabled',
      },
    },
    isHovered: {
      true: {
        ...
        input: 'text-select-text-color-hover placeholder:text-select-placeholder-color-hover',
        ...
        trigger: 'border-b-select-border-bottom-color-hover border-l-select-border-left-color-hover border-r-select-border-right-color-hover border-t-select-border-top-color-hover bg-select-bg-color-hover shadow-select-shadow-hover',
      },
    },
    isFocused: {
      true: {
        ...
        input: 'text-select-text-color-focus placeholder:text-select-placeholder-color-focus',
        ...
        trigger: 'border-b-select-border-bottom-color-focus border-l-select-border-left-color-focus border-r-select-border-right-color-focus border-t-select-border-top-color-focus bg-select-bg-color-focus shadow-select-shadow-focus ring-2 ring-select-ring-color-focus',
      },
    },
    hasError: {
      true: {
        ...
        input: 'text-select-text-color-error placeholder:text-select-placeholder-color-error',
        ...
        trigger: 'border-b-select-border-bottom-color-error border-l-select-border-left-color-error border-r-select-border-right-color-error border-t-select-border-top-color-error bg-select-bg-color-error shadow-select-shadow-error ring-select-ring-color-error',
      },
    },
  },
})
