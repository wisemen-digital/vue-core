...
export const selectStyle = tv({
  slots: {
    ...
    listboxContent: 'max-h-select-dropdown-max-height-default overflow-y-auto px-select-dropdown-padding-x-default outline-none',
