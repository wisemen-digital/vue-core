...
export const useDialogStyle = tv({
  slots: {
    ...
    content: 'fixed left-1/2 top-1/2 z-dialog -translate-x-1/2 -translate-y-1/2 rounded-dialog bg-dialog text-dialog-foreground shadow-dialog-shadow outline-none',
