...
export const useComboboxStyle = tv({
  defaultVariants: {},
  slots: {
    content: 'custom-combobox-content custom-popover-content relative z-popover max-h-[--radix-combobox-content-available-height] w-[--radix-combobox-trigger-width] min-w-min overflow-hidden rounded-popover border border-solid border-border bg-select-popover shadow-popover-shadow',
    ...
    icon: 'text-select-popover-foreground',
    ...
    inputLoader: 'pointer-events-none size-4 text-select-popover-foreground',
    ...
    optionIndicator: 'text-select-popover-foreground',
