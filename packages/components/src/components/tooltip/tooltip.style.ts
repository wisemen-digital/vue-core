...
export const tooltipStyle = tv({
  slots: {
    ...
    content: 'custom-z-popover custom-popover-content rounded-tooltip-border-radius-default border border-solid border-tooltip-border-color-default bg-tooltip-bg-color-default text-tooltip-text-color-default shadow-tooltip-shadow-default',
  },
})
