...
export const useSidebarNavStyle = tv({
  slots: {
    containerClosed: 'sticky left-0 top-0 flex h-screen min-w-20 max-w-20 flex-col items-center justify-between gap-6 border border-solid border-muted bg-background px-3 py-6 transition-all duration-100',
    containerOpen: 'sticky left-0 top-0 flex h-screen min-w-64 max-w-64 flex-col items-start justify-between gap-6 border border-solid border-muted bg-background px-3 py-6 transition-all duration-100',
