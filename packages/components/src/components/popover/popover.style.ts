...
export const popoverStyle = tv({
  slots: {
    ...
    content: 'custom-popover-content z-popover min-w-popover-min-width-default max-w-popover-max-width-default rounded-popover-border-radius-default border border-solid border-popover-border-color-default bg-popover-bg-color-default shadow-popover-shadow-default',
  },
})
