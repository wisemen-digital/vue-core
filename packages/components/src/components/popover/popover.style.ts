...
export const popoverStyle = tv({
  slots: {
    ...
    content: 'custom-z-popover custom-popover-content min-w-popover-min-width-default max-w-popover-max-width-default rounded-popover-border-radius-default border border-solid border-popover-border-color-default bg-popover-bg-color-default shadow-popover-shadow-default',
  },
})
