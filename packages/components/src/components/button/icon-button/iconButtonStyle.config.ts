...
export function setupDefaultIconButtonStyles(): void {
  ...
  defineStyleConfig({
    colorScheme: '*',
    config: {
      '--icon-button-bg-color-active': 'var(--brand-primary-800)',
      '--icon-button-bg-color-default': 'var(--brand-primary-600)',
      '--icon-button-bg-color-disabled': 'var(--bg-disabled)',
      '--icon-button-bg-color-focus': 'var(--brand-primary-600)',
      '--icon-button-bg-color-hover': 'var(--brand-primary-700)',
      '--icon-button-border-color-active': 'var(--brand-primary-800)',
      '--icon-button-border-color-default': 'var(--brand-primary-600)',
      '--icon-button-border-color-disabled': 'var(--border-disabled-subtle)',
      '--icon-button-border-color-focus': 'var(--brand-primary-600)',
      '--icon-button-border-color-hover': 'var(--brand-primary-700)',
      ...
      '--icon-button-ring-color-focus': 'var(--brand-primary-500)',
  ...
  defineStyleConfig({
    ...
    config: {
      ...
      '--icon-button-bg-color-disabled': 'var(--bg-primary)',
      '--icon-button-bg-color-focus': 'var(--bg-primary)',
      '--icon-button-bg-color-hover': 'var(--brand-primary-50)',
      '--icon-button-border-color-active': 'var(--brand-primary-300)',
      '--icon-button-border-color-default': 'var(--brand-primary-300)',
      '--icon-button-border-color-focus': 'var(--brand-primary-300)',
      '--icon-button-border-color-hover': 'var(--brand-primary-300)',
      '--icon-button-icon-color-active': 'var(--brand-primary-900)',
      '--icon-button-icon-color-default': 'var(--brand-primary-700)',
      '--icon-button-icon-color-focus': 'var(--brand-primary-700)',
      '--icon-button-icon-color-hover': 'var(--brand-primary-800)',
      '--icon-button-loader-color-active': 'var(--brand-primary-900)',
      '--icon-button-loader-color-default': 'var(--brand-primary-700)',
      '--icon-button-loader-color-focus': 'var(--brand-primary-700)',
      '--icon-button-loader-color-hover': 'var(--brand-primary-800)',
      '--icon-button-shadow-active': 'var(--shadow-xs)',
      '--icon-button-shadow-default': 'var(--shadow-xs)',
      '--icon-button-shadow-disabled': 'var(--shadow-xs)',
      '--icon-button-shadow-focus': 'var(--shadow-xs)',
  ...
  defineStyleConfig({
    ...
    config: {
      ...
      '--icon-button-border-color-active': 'var(--gray-700)',
      '--icon-button-border-color-default': 'var(--gray-700)',
      '--icon-button-border-color-disabled': 'var(--gray-700)',
      '--icon-button-border-color-focus': 'var(--gray-700)',
      '--icon-button-border-color-hover': 'var(--gray-700)',
  ...
  defineStyleConfig({
    ...
    config: {
      ...
      '--icon-button-bg-color-focus': 'transparent',
      '--icon-button-bg-color-hover': 'var(--brand-primary-50)',
      '--icon-button-border-color-active': 'var(--brand-primary-50)',
      '--icon-button-border-color-default': 'transparent',
      '--icon-button-border-color-disabled': 'transparent',
      '--icon-button-border-color-focus': 'transparent',
      '--icon-button-border-color-hover': 'var(--brand-primary-50)',
      '--icon-button-icon-color-active': 'var(--brand-primary-800)',
      '--icon-button-icon-color-default': 'var(--brand-primary-700)',
      '--icon-button-icon-color-focus': 'var(--brand-primary-700)',
      '--icon-button-icon-color-hover': 'var(--brand-primary-800)',
      '--icon-button-loader-color-active': 'var(--brand-primary-800)',
      '--icon-button-loader-color-default': 'var(--brand-primary-700)',
      '--icon-button-loader-color-focus': 'var(--brand-primary-700)',
      '--icon-button-loader-color-hover': 'var(--brand-primary-800)',
      '--icon-button-shadow-disabled': '0 0 0 0 transparent',
