...
export const useCalendarStyle = tv({
  slots: {
    ...
    headerPrevNext: 'inline-flex size-8 cursor-pointer items-center justify-center rounded-[9px] bg-transparent text-foreground hover:bg-primary/20 focus:shadow-[0_0_0_2px] focus:!shadow-primary focus:outline-none active:scale-90 active:transition-all',
