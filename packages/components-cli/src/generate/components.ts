import { badge } from '@/generate/files/components/badge'
import { breadcrumbs } from '@/generate/files/components/breadcrumbs'
import { button } from '@/generate/files/components/button'
import { checkbox } from '@/generate/files/components/checkbox'
import { combobox } from '@/generate/files/components/combobox'
import { command } from '@/generate/files/components/command'
...
import { tagsInput } from '@/generate/files/components/tagsInput'
import { toast } from '@/generate/files/components/toast'
import { toggle } from '@/generate/files/components/toggle'
import { tooltip } from '@/generate/files/components/tooltip'
