...
export { default as VcFileUploadRoot } from '@/components/file-upload/parts/FileUploadRoot.vue'
export { default as VcFileUploadTrigger } from '@/components/file-upload/parts/FileUploadTrigger.vue'
